...
import Listpopupmessages from "../popupsdrawers/listpopupmessages";
    ...
    return (
      <>
        <div className="navbarbetfun">
          ...
          <div className="phonescreenbetpub">
            <FontAwesomeIcon
              icon={faDiceD6}
              size="lg"
              color="black"
            ...
            />
            <ViewListIcon
              onClick={this.openDrawerCommunities}
              style={{ cursor: "pointer" }}
            />
          ...
          <div className="notificationContainer">
            ...
            />
            {/* <Listpopupmessages> */}
            <SimpleBadge number={4}>
              <MailIcon style={{ cursor: "pointer" }} />
            </SimpleBadge>
            {/* </Listpopupmessages> */}
            <SimpleBadge number={4}>
              <NotificationsIcon
                style={{ cursor: "pointer", color: "#e6ab2d" }}
              />
            </SimpleBadge>
          </div>
        </div>
        ...
        />
        <MyDrawerCommunities
          open={this.state.opendrawercommunities}
          handleDrawerClose={this.closeDrawerCommunities}
        />
        <MyDrawerDomains
